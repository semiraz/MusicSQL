...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/IdeaProjects/Music/" + DB_NAME;
...
//    SELECT name, album, track FROM artist_list WHERE title = ?     ? - placeholder
    ...
    public int getCount(String table) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            System.out.printf("Query failed: " + e.getMessage());
            return -1;
        }
